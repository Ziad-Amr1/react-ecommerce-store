...
export default function ProductsTable({ 
  ...
  const columns = [ 
    { key: "product", label: t("products.columns.product"), sortable: true, sortKey: "name", className: "w-[30%]" }, 
    { key: "category", label: t("products.columns.category"), sortable: true, sortKey: "category", className: "w-[18%]" }, 
    { key: "brand", label: t("products.columns.brand"), sortable: true, sortKey: "brand", className: "w-[18%]" }, 
    { key: "price", label: t("products.columns.price"), align: "start", sortable: true, sortKey: "price", className: "w-[14%]" }, 
    { key: "stock", label: t("products.columns.stock"), sortable: true, sortKey: "stock", className: "w-[10%]" }, 
    { key: "actions", label: t("products.columns.actions"), align: "end", className: "w-[10%]" }, 
  ]; 
 
  return ( 
    <div className="overflow-hidden rounded-lg border bg-card shadow-sm"> 
      <div className="overflow-x-auto"> 
        <Table density="compact" edgePadding className="min-w-[900px]"> 
          <SortableTableHeader 
            columns={columns} 
            sortKey={sortKey} 
                  ...
                  products.map((product) => { 
                    ...
                    return ( 
                      <TableRow 
                        ...
                        onClick={() => onProductClick?.(product._id) ?? onView?.(product._id)} 
                      > 
                        ...
                        <TableCell className="whitespace-nowrap text-start tabular-nums"> 
                          {product.price == null 
                            ? "—" 
                            : formatCurrency( 
                              product.price, 
