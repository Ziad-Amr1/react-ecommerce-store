  ...
  return (
    <main className="mx-auto w-full max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
      ...
      {status === "loading" ? (
        ...
        <div className="flex flex-col items-center justify-center rounded-2xl border bg-muted/40 p-12 text-center">
          ...
          <Button
            asChild
            className="mt-6 cursor-pointer gap-2 rounded-full"
          >
            <Link to="/products">
