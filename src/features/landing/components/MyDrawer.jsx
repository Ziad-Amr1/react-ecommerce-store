...
const drawerLinks = [
  {
    id: 0,
    labelKey: "store.header.nav.home",
    path: "/",
    icon: House,
  },
  {
    id: 1,
    labelKey: "store.header.nav.shop",
    path: "/products",
    icon: Package,
  },
  {
    id: 2,
    labelKey: "store.header.nav.about",
    path: "/about",
    icon: Info,
  },
];
          ...
          >
            ...
            <div className="min-w-0">
              <p className="truncate text-sm font-medium text-[var(--color-text-primary)]">
                {t("store.header.drawer.saleTitle")}
              </p>
              <p className="truncate text-xs text-[var(--color-text-secondary)]">
                {t("store.header.drawer.saleDetails")}
              </p>
            </div>
          </div>
