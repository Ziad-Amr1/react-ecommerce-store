    ...
    return ( 
        <div className="w-full rounded-xl border border-border bg-card p-6 shadow-sm md:w-80 md:shrink-0"> 
            ...
            <div className="space-y-4"> 
                <label 
                    className={`flex min-h-45 flex-col items-center justify-center rounded-lg border border-dashed border-border text-center transition ${totalImages >= 5 || isSubmitting ? "cursor-not-allowed opacity-50" : "cursor-pointer hover:bg-muted" 
                        }`} 
                > 
